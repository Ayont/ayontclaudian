...
const CONTROL_SECTIONS = ['fast-chip', 'model-picker', 'composer-toolbar', 'browser-activity', 'history-panel', 'history-search', 'subagent-cards', 'subagent-swarm', 'subagent-inspector'] as const;
