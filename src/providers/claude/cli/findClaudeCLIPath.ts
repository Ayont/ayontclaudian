...
function resolveClaudeFromPathEntries(
  ...
  // An extension-less `claude` on a Windows PATH entry is npm's POSIX sh shim,
  // which cannot be spawned directly. Skip it like the .cmd shim and fall
  // through to the Node-backed package entrypoint below (YishenTu/claudian #1042).
