 ...
 */
export interface ClineGoalLoopDeps {
...
export interface ClineGoalLoopResult {
  iterations: number;
...
export async function* runClineGoalLoop(params: {
  goal: string;
  initialPrompt: string;
  deps: ClineGoalLoopDeps;
}): AsyncGenerator<StreamChunk, ClineGoalLoopResult> {
