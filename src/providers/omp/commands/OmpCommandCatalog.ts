...
export class OmpCommandCatalog implements ProviderCommandCatalog {
  ...
  async saveVaultEntry(_entry: ProviderCommandEntry): Promise<void> {
    throw new Error('OMP runtime commands are not editable from Claudian.');
  }

  async deleteVaultEntry(_entry: ProviderCommandEntry): Promise<void> {
    throw new Error('OMP runtime commands are not deletable from Claudian.');
  }
