...
/**
 * Node-backed fetch implementation that bypasses Electron/browser renderer CORS restrictions
 * while providing a standards-compliant fetch Response object with ReadableStream body support.
 */
