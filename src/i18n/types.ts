...
export type TranslationKey =
  ...
  | 'chat.contextPressure.continueFreshHint'
  | 'chat.contextPressure.condensing'
  | 'chat.contextPressure.streamingNote'
  | 'chat.contextPressure.dismiss'
  | 'chat.contextPressure.regionLabel'
  | 'chat.contextPressure.freshSessionDivider'
  | 'chat.contextPressure.freshSessionBusy'
  | 'chat.contextPressure.freshSessionAborted'
  | 'chat.contextPressure.freshSessionFailed'
  | 'chat.contextPressure.freshSessionUnsaved'
  | 'chat.contextMeter.estimatedPrefix'
  | 'chat.contextMeter.nearLimitCompact'
  | 'chat.contextMeter.nearLimit'
  ...
  | 'settings.providers.alwaysOn'
  | 'settings.providers.openTab'
